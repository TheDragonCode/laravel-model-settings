...
test('success', function () {
    ...
    app(ModelStorage::class)->forget($user1, IntBackedEnum::Foo);
    app(ModelStorage::class)->forget($user2, StringBackedEnum::Bar);
    app(ModelStorage::class)->forget($user3, UnitEnum::Baz);
