...
ідэнтыфікатары, UUID і ULID. Для даўжэйшага карыстальніцкага першаснага ключа патрэбна адпаведнае
змяненне міграцыі.

Значэнне `0` у `item_id` зарэзервавана для налад класа па змаўчанні. Калі даныя ўжо існуюць, змяненне
падключэння, назвы табліцы або псеўданімаў morph map патрабуе самастойнага пераносу або абнаўлення
радкоў.
...
| Пераўтвараць `item_id` у `string` | Цэлыя лікі, UUID і ULID захоўваюцца ў адным слупку |
